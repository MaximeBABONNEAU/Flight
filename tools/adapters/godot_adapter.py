    ...
    def _verify_all(
        ...
        **_kwargs: Any,
        ...
        Flow:
          ...
          3b. [C49] Diff each current capture vs the previous run's capture
            ...
            scene_results.append(
                {
                    ...
                    # C49: pixel_diff_pct + visual_regression are populated
                    # by the regression-diff pass below. Defaults here keep
                    # the schema stable when capture is disabled or no
                    # baseline exists.
                    "pixel_diff_pct": 0.0,
        ...
        self.log(
            ...
            f"visual_regressions={visual_regressions} "
